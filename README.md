Для запуска проект необходимо выполнить следующую команду с корня проекта(название директории в которую клонируется репозиторий, должен называться "Somnium test"):<br>
